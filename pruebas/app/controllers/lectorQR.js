...
/**   CONFIGURACION DEL MODULO
 VERSIONES: ANDROID-3.1.0 IOS-1.10.1 
...
/**
 * Función que se encarga de escanear un codigo QR de la galeria.
 * Nota: al escanear un codigo QR de la galeria NO se emite sonido(bip).
 */
